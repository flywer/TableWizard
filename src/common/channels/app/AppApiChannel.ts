...
export class AppApiChannel {
	...
	// 选择文件路径
	static SELECT_FILE_PATH = StringUtils.joinPaths(this.channelsPrefix, 'selectFilePath')
	// 选择文件夹路径
	static SELECT_FOLDER_PATH = StringUtils.joinPaths(this.channelsPrefix, 'selectFolderPath')
}
