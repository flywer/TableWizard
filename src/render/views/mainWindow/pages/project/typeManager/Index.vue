<template>
	...
	>
		<template #1>
			<TypeManagerMenu :projectId="projectId" class="relative top-2 left-2 right-4"/>
		</template>
		<template #2>
...
import TypeManagerMenu from "@render/components/project/typeManager/TypeManagerMenu.vue";
...
defineOptions({name: 'ProjectTypeManager'})
