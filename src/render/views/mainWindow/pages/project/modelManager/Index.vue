	...
	>
		...
		<template #2>
			<n-tabs
				...
				class="relative top-2 left-2 right-4"
				type="card"
				:size="'small'"
				:addable="false"
				:closable="true"
...
import ModelOverview from "@render/components/project/modelManager/ModelOverview.vue";
import DataTableModel from "@render/components/project/modelManager/DataTableModel.vue";
