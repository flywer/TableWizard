...
export class AppApi {
	...
	static selectFilePath = () => {
		return ipcInstance.send(AppApiChannel.SELECT_FILE_PATH)
	}

	static selectFolderPath = (): Promise<string> => {
		return ipcInstance.send(AppApiChannel.SELECT_FOLDER_PATH)
	}
}
